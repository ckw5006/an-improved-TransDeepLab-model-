...
class SwinEncoder(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3,
        ...
        ########################
        self.low_level_dim2 = int(embed_dim * 2)

        #print("self.low_level_norm",low_level_idx,embed_dim,embed_dim * 4 ** low_level_idx)  

        self.low_level_norm2 = norm_layer(self.low_level_dim2) #if low_level_norm else None
    def forward(self, x):
        """
...
#         print("xxx1",x.size())  
        ...
        low_level=low_level_2 = high_level = None
        if self.low_level_idx == 0 and not self.low_level_after_block:
            low_level = x
#             print("low_level111",low_level.size())
        down = None
        depth = 0
        ...
        for layer in self.layers:
            ...
            if depth == self.low_level_idx and self.low_level_after_block:
                low_level = x
#                 print("low_level222",low_level.size())
            if depth == self.low_level_idx+1 and self.low_level_after_block:
                low_level_2 = x
            ...
            if depth == self.low_level_idx and not self.low_level_after_block:
                low_level = down
                print("low_level333",low_level.size())
...
#             print("low_level_2 44",low_level_2.size())    
            low_level_2 = self.low_level_norm2(low_level_2)
#             print("low_level444",low_level.size())    
...
#         print("low_level444",low_level.size())
#         print("high_level4444",high_level.size())  
        return low_level,low_level_2, high_level
